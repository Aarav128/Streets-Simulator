...
public class Weapon extends Item {
    ...
    public Weapon(String name, String description, int durability, int durabilityPerUse, int power, int price) {
        super(name, description, durability, durabilityPerUse, 0, "", price);
        this.power = power;
    }
    public int getPower() {
        return power;
